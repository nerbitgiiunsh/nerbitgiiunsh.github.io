    ...
    (function () {
      ...
      ((p.parseCSSElements = function () {
        ...
        (p.parseThumbs = function (e) {
          ...
          (o.attr("data-src", e.thumbURL),
            o.attr("src", p.defaults.popupThumbPlaceholder),
            n.prepend(o),
            p.addLazyElement(o[0]),
          ...
          return (
            (e = [
              ...
              },
              {
                ...
                value: function (e, t) {
                  var i = this.app,
                    n = i.provider,
                    o = t.pageNumber,
                    s = E.ifdef(t.textureTarget, p.TEXTURE_TARGET.VIEWER);
              ...
              },
              {
                ...
                value: function (e) {
                  null != e.touches &&
                    ...
                    ((this.startTouches = E.getTouches(e)),
                    (this.app.viewer.zoomCenter = E.getVectorAvg(
                      E.getTouches(e, this.parentElement.offset()),
                    )),
                    (this.lastScale = 1));
                },
              },
              ...
              },
              {
                ...
                value: function (e) {
                  if (
                    ...
                    var t = E.calculateScale(
                      this.startTouches,
                      E.getTouches(e),
                    );
                    (this.lastScale,
                      (this.lastScale = t),
                      (this.app.viewer.pinchZoomUpdateScale = E.limitAt(
                        t,
              ...
              },
              {
                ...
                value: function (e) {
                  return E.limitAt(e, 1, this.app.dimensions.maxTextureHeight);
                },
              },
              {
                key: "textureWidthLimit",
                value: function (e) {
                  return E.limitAt(e, 1, this.app.dimensions.maxTextureWidth);
                },
              },
              {
                key: "setPage",
                value: function (e) {
                  E.log("Set Page detected", e.pageNumber);
            ...
            (i = [
                ...
                value: function (e) {
                  if ("-1" !== e.textureStamp && void 0 !== e.pageNumber) {
                    for (
                      ...
                      if (t === s) {
                        z.log("Page " + t + " already in buffer, skipping");
                        return;
                      }
                    ...
                    this.app.pageScaling === p.PAGE_SCALE.PAGE_WIDTH
                      ...
                      : this.app.pageScaling === p.PAGE_SCALE.AUTO
                        ...
                        : this.app.pageScaling === p.PAGE_SCALE.ACTUAL &&
                          (n = 1 * t.height),
                    (n -= 2),
                    (this._containCover = z.contain(t.width, t.height, i, n)),
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return (void 0 === t && z.log("Page Not found for: " + e), t);
                },
              },
              {
                key: "onScroll",
              ...
              { key: "validatePageChange", value: function (e) {} },
              {
                ...
                value: function () {
                  if (!0 !== this.skipScrollIntoView) {
                    ...
                    null != e &&
                      z.scrollIntoView(e.element[0], this.element[0]);
                  }
      ...
      function G(e) {
        ...
        return function () {
          ...
          return (
            (i = t
              ? Reflect.construct(n, arguments, j(this).constructor)
            ...
            U(i, [
              {
                key: "init",
                value: function () {
                  (V(j(i.prototype), "init", this).call(this),
                    this.initSound());
                  var e = this.app;
                  ((this.pageMode =
                    e.options.pageMode === p.FLIPBOOK_PAGE_MODE.AUTO
                      ? K.isMobile || e.pageCount <= 2
              ...
              { key: "determineHeight", value: function () {} },
              {
                key: "initCustomControls",
                value: function () {
                  V(j(i.prototype), "initCustomControls", this).call(this);
                  var e = this,
                    t = this.app,
                    n = t.ui,
                    o = n.controls,
                    s = t.options.text,
                    a = t.options.icons;
                  ((o.sound = K.createBtn("sound", a.sound, s.toggleSound).on(
                    "click",
                    function () {
              ...
              },
              {
                key: "dispose",
                value: function () {
                  V(j(i.prototype), "dispose", this).call(this);
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return this.filterViewPort(
                    V(j(i.prototype), "getViewPort", this).call(this, e, t),
                    e,
                    n,
                  );
                },
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  p.MOUSE_SCROLL_ACTIONS.ZOOM
                    ...
                    : V(j(i.prototype), "mouseWheel", this).call(this, e);
                },
              },
              {
                key: "checkRequestQueue",
                value: function () {
                  this.app.zoomValue > 1
                    ...
                    : V(j(i.prototype), "checkRequestQueue", this).call(this);
                },
              },
                  ...
                  return (
                    (o =
                      this.app.zoomValue > 1 || !0 === n
                        ...
                        : V(j(i.prototype), "getAnnotationElement", this).call(
                            this,
                            e,
                            t,
                          )) &&
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return this.app.zoomValue > 1 || !0 === n
                    ...
                    : V(j(i.prototype), "getTextElement", this).call(
                        this,
                        e,
                        t,
                      );
                  ...
                  if (
                    (o && "-1" === o.textureStamp
                      ? ((o.textureStamp = n.textureStamp),
                        ...
                        K.log("Texture Exchanging at " + i))
                      : K.log("Texture Exchanging Bypassed at " + i),
                    !this.isBooklet)
                  ) {
                    ...
                    a && "-1" === a.textureStamp
                      ? ((a.textureStamp = s.textureStamp),
                        ...
                        K.log("Texture Exchanging at " + (i + 1)))
                      : K.log("Texture Exchanging Bypassed at " + (i + 1));
                  }
                  t.pagesReady();
                },
              },
              ...
              },
              {
                ...
                value: function (e) {
                  return e.textureTarget === p.TEXTURE_TARGET.ZOOM
                    ...
                    : V(j(i.prototype), "setPage", this).call(this, e);
                },
              },
              {
                ...
                value: function () {
                  ...
                  ((this._defaultPageSize = K.contain(t.width, t.height, i, o)),
              ...
              },
              {
                ...
                value: function (e) {
                  if (!this.isDoubleInternalPage(e))
                    return V(j(i.prototype), "cleanPage", this).call(this, e);
                  var t = e + (e % 2 == 1 ? -1 : 1);
                  return (
              ...
              },
              {
                key: "onReady",
                value: function () {
                  V(j(i.prototype), "onReady", this).call(this);
                },
              },
              {
                key: "searchPage",
          ...
          return (
            U(i, [
              ...
              },
              {
                key: "resetTexture",
                value: function () {
                  (V(j(i.prototype), "resetTexture", this).call(this),
            ...
            U(i, [
              {
                ...
                value: function () {
                  ((this.leftPage = new Q()),
                    ...
                    (this.bookShadow = Z("<div>", { class: "df-book-shadow" })),
              ...
              },
              {
                ...
                value: function () {
                  ((this.stageDOM = this.element[0]),
                    V(j(i.prototype), "initEvents", this).call(this));
                },
              },
              {
                key: "dispose",
              ...
              },
              {
                key: "mouseUp",
                value: function (e) {
                  (V(j(i.prototype), "mouseUp", this).call(this, e),
                    this.startZoomUpdateRequest());
                },
              },
              {
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  if (void 0 !== s) {
                    var a = K.elementIntersection(t.element, s.element, !0);
      ...
      function et(e, t, i) {
        return (t && ee(e.prototype, t), i && ee(e, i), e);
      }
      function ei(e, t, i) {
        return (ei =
          "undefined" != typeof Reflect && Reflect.get
      ...
      function ea(e) {
        ...
        return function () {
          ...
          return (
            (i = t
              ? Reflect.construct(n, arguments, en(this).constructor)
              : n.apply(this, arguments)),
            i &&
            ("object" ==
              (i && "undefined" != typeof Symbol && i.constructor === Symbol
      ...
      var er = p.jQuery,
        ...
        eh = /*#__PURE__*/ (function (e) {
          ...
          function i(e) {
            var n;
            return ($(this, i), (n = t.call(this, e)).init(), n);
          }
          return (
            et(i, [
              {
                  ...
                  ((e = Math.floor(e)),
                    ...
                    (this.wrapper[0].style.height =
                      this.wrapper[0].style.width =
                        Math.ceil(
                          el.distOrigin(e, t) * this.viewer.app.zoomValue,
                        ) + "px"),
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  if (
                    ...
                    (!0 === t.isHard
                      ? (null != e &&
                          (h = el.angleByDistance(e.distance, e.fullWidth)),
              ...
              },
              {
                ...
                value: function (e) {
                  if (null != e) {
                    ...
                    r = Math.PI / 2 - el.limitAt(r, 0, el.toRad(90));
                    var l = t - e.rx / 2,
                      h = e.ry / 2,
                      u = Math.max(
                        0,
                        Math.sin(r - Math.atan2(h, l)) * el.distOrigin(l, h),
                      ),
                      c = 0.5 * el.distOrigin(e.rx, e.ry),
                      ...
                      P = s ? -d : d - t,
                      S = a ? -i - f : f,
                      E = el.limitAt((0.5 * e.distance) / t, 0, 0.5),
                      x = el.limitAt(
                    ...
                    (this.wrapper.css({
                      transform: el.translateStr(b, w) + el.rotateStr(v),
                    }),
                      T.css({
                        transform: el.rotateStr(-v) + el.translateStr(-b, -w),
                      }),
                      C.css({
                        transform: el.rotateStr(m) + el.translateStr(P, S),
                        boxShadow: "rgba(0, 0, 0, " + E + ") 0px 0px 20px",
                      }),
                      O.css({
                        transform: el.rotateStr(m) + el.translateStr(P, S),
                        opacity: x / 2,
        ...
        eu = /*#__PURE__*/ (function (e) {
          ...
          function i(e, n) {
            ...
            return (
              ...
              ((o = t.call(this, e, n)).bookShadow = er("<div>", {
            ...
            et(i, [
              {
                key: "init",
                value: function () {
                  (ei(en(i.prototype), "init", this).call(this),
                    this.initEvents(),
                    this.initPages());
                },
              },
              {
                ...
                value: function () {
                  ((this.stageDOM = this.element[0]),
                    ei(en(i.prototype), "initEvents", this).call(this));
                },
              },
              {
                key: "dispose",
                value: function () {
                  (ei(en(i.prototype), "dispose", this).call(this),
                    this.element.remove());
                },
              },
              {
                ...
                value: function () {
                  for (var e = 0; e < this.stackCount; e++) {
                    var t = new eh({ parentElement: this.wrapper });
                    ((t.index = e),
                      (t.viewer = this),
                      this.sheets.push(t),
              ...
              },
              {
                key: "resize",
                value: function () {
                  ei(en(i.prototype), "resize", this).call(this);
                  var e = this.app.dimensions,
                    t = e.padding,
                    ...
                    h = (this.shiftHeight = Math.ceil(
                      el.limitAt((a - l + t.height) / 2, 0, a),
                    )),
                    u = (this.shiftWidth = Math.ceil(
                      el.limitAt((s - r + t.width) / 2, 0, s),
                    ));
                  (1 === this.app.zoomValue &&
                    ((this.left = 0), (this.top = 0)),
                    this.element.css({
              ...
              },
              {
                ...
                value: function (e) {
                  return (
                    !!this.isVertical() ||
                    ei(en(i.prototype), "isSheetHard", this).call(this, e)
                  );
                },
              },
            ]),
      ...
      function ed(e, t, i) {
        return (t && ec(e.prototype, t), i && ec(e, i), e);
      }
      function ef(e, t, i) {
        return (ef =
          "undefined" != typeof Reflect && Reflect.get
      ...
      function ey(e) {
        ...
        return function () {
          ...
          return (
            (i = t
              ? Reflect.construct(n, arguments, eg(this).constructor)
              : n.apply(this, arguments)),
            i &&
            ("object" ==
              (i && "undefined" != typeof Symbol && i.constructor === Symbol
      ...
      var eb = p.utils,
        ew = /*#__PURE__*/ (function (e) {
          ...
          var t = ey(i);
          function i() {
            return (ep(this, i), t.apply(this, arguments));
          }
          return (
            ed(i, [
              {
            ...
            ed(i, [
              {
                ...
                value: function () {
                  for (var e = 0; e < this.stackCount; e++) {
                    var t = new ew({ parentElement: this.wrapper });
                    ((t.index = e),
                      (t.viewer = this),
                      this.sheets.push(t),
                      this.pages.push(t.frontPage),
              ...
              },
              {
                key: "resize",
                value: function () {
                  (ef(eg(i.prototype), "resize", this).call(this),
              ...
              },
              {
                key: "refresh",
                value: function () {
                  (ef(eg(i.prototype), "refresh", this).call(this),
              ...
              },
              {
                key: "eventToPoint",
                value: function (e) {
                  var t = ef(eg(i.prototype), "eventToPoint", this).call(
                    this,
                    e,
                  );
                  return (
              ...
              },
              {
                ...
                value: function (e) {
                  ((e.isSingle = !0),
                    ef(eg(i.prototype), "setPageMode", this).call(this, e));
                },
              },
              {
                key: "pagesReady",
      ...
      function eC(e, t, i) {
        return (t && ex(e.prototype, t), i && ex(e, i), e);
      }
      function eT(e) {
      ...
      function eR(e) {
        ...
        return function () {
          ...
          return (
            (i = t
              ? Reflect.construct(n, arguments, eT(this).constructor)
              : n.apply(this, arguments)),
            i &&
            ("object" ==
              (i && "undefined" != typeof Symbol && i.constructor === Symbol
      ...
      function eB(e) {
        ...
        return function () {
          ...
          return (
            (i = t
              ? Reflect.construct(n, arguments, eD(this).constructor)
              : n.apply(this, arguments)),
            i &&
            ("object" ==
              (i && "undefined" != typeof Symbol && i.constructor === Symbol
        ...
        if (!0 !== eL.initialized) {
          ...
          ((eL = {
              ...
              return (
                "CANVAS" === i.nodeName || "IMG" === i.nodeName
                  ? (((r = new e.Texture(i)).needsUpdate = !0),
                    eL.loadTexture(r, t, o, n),
                    "function" == typeof s && s(t, r))
                  : "blank" !== i
                    ? (r =
                        null == i
                          ? null
                          : eL.textureLoader.load(
                              i,
                              function (e) {
                                ((e.sourceFile = i),
                                  eL.loadTexture(e, t, o, n),
                              ...
                              function () {
                                (null == r.image &&
                                  eL.loadImage(
                                    t,
                                    eL.defaults.textureLoadFallback,
                                    n,
                                    o,
                                  ),
                                  eL.loadTextureFailed());
                              },
                            )) && (r.mapping = e.UVMapping)
                    : (eL.loadTexture(null, t, o, n),
                      "function" == typeof s && s(t, r)),
                0
              );
            },
            loadTexture: function (t, i, n, o) {
              ...
              (null !== t &&
                "map" === n &&
                ((t.anisotropy = 0),
                eL.defaults.anisotropy > 0 &&
                  (t.anisotropy = eL.defaults.anisotropy),
                !0 === e.skipPowerOfTwo &&
                  ((t.minFilter = e.LinearFilter),
                  (t.magFilter = e.LinearFilter)),
                (t.name = new Date().toTimeString())),
                eL.clearTexture(i.material[o][n]),
                (i.material[o][n] = t),
                "bumpMap" === n &&
          ...
          var t = /*#__PURE__*/ (function (t) {
              ...
              function n(t) {
                eE(this, n);
                var o,
                  s = t.width || eL.defaults.width,
                  a = t.height || eL.defaults.height,
                  r = t.color || eL.defaults.color,
                  l = t.segments || eL.defaults.segments,
                  h = t.depth || eL.defaults.depth,
                  u = {
                    color: r,
                    flatShading: !1,
                    shininess: t.shininess || eL.defaults.shininess,
                  },
                ...
                eC(n, [
                  {
                    key: "loadImage",
                    value: function (e, t, i) {
                      eL.loadImage(this, e, t, "map", i);
                    },
                  },
                  {
                    key: "frontImage",
                    value: function (e, t) {
                      eL.loadImage(this, e, eL.MATERIAL_FACE.FRONT, "map", t);
                    },
                  },
                  {
                    key: "backImage",
                    value: function (e, t) {
                      eL.loadImage(this, e, eL.MATERIAL_FACE.BACK, "map", t);
                    },
                  },
                  {
                    key: "loadBump",
                  ...
                  },
                  {
                    ...
                    value: function (e, t) {
                      if (void 0 !== t) {
                        eL.loadImage(this, e, t, "normalMap", null);
                        return;
                      }
                      (eL.loadImage(
                        this,
            ...
            i = /*#__PURE__*/ (function (e) {
              ...
              function i(e) {
                ...
                return (
                  ...
                  n.frontImage(eL.defaults.groundTexture),
                  n.backImage(eL.defaults.groundTexture),
                  (n.type = "Ground"),
                  n
                );
              }
                      ...
                      for (
                        ...
                        if (i.children && i.children.length > 0)
                          for (var n = i.children.length - 1; n >= 0; n--)
                            eL.clearChild(i.children[n]);
                        (eL.clearChild(i), (i = null));
                      }
                      this.render();
                    },
                  },
          ...
          var s = /*#__PURE__*/ (function (e) {
            ...
            var t = eR(i);
            function i(e) {
              return (eE(this, i), t.call(this, e));
            }
            return i;
          })(e.CSS3DObject);
          ((e.CSS3DSprite = s),
        ...
        eV = /*#__PURE__*/ (function (e) {
          ...
          function i(e) {
            ...
            return (
              ...
              (n.depth = e.depth || 0.5),
              (n.matColor = "white"),
              (n.fallbackMatColor = eL.WHITE_COLOR),
              n.init(),
            ...
            eI(i, [
              {
                ...
                value: function () {
                  ((this.element = new eL.Paper({
                    ...
                    (this.frontPage = new eW({ sheet: this, face: 5 })),
                    (this.backPage = new eW({ sheet: this, face: 4 })),
                    this.reset(),
                    this.updateAngle());
                },
              },
                ...
                value: function () {
                  if (void 0 !== this.viewer && null !== this.viewer) {
                    ...
                    for (var b = 0; b < 1; b++) {
                      ...
                      for (
                        var P = void 0, S = r[b][0], E = 1;
                        E < r[b].length;
                        E++
                      )
                        ((c += (P = r[b][E]).distanceTo(S)),
                          d.push(c),
                          (S = P));
                      ...
                      for (var A = 0; A < 1; A++)
                        for (var I = 1; I < i; I++)
                          ((L[N].z = L[N + 3 * _].z = l[0][I].z),
                            ...
                            N++);
                      for (
                        var M = x.faceVertexUvs[0], D = x.faces, z = 0, F = 0;
                        F < M.length;
                        F++
                      )
                        if (D[F].materialIndex === eL.MATERIAL_FACE.BACK) {
                          var B = d[z] / c;
                          F % 2 == 0
                            ? ((M[F][0].x = M[F][1].x = M[F + 1][0].x = B), z++)
                            : (M[F - 1][2].x = M[F][1].x = M[F][2].x = B);
                        } else if (
                          D[F].materialIndex === eL.MATERIAL_FACE.FRONT
                        ) {
                          var H = 1 - d[z] / c;
                          F % 2 == 0
                            ? ((M[F][0].x = M[F][1].x = M[F + 1][0].x = H), z--)
          ...
          return (
            eI(i, [
              ...
              },
              {
                ...
                value: function () {
                  var e = this.app;
                  (eM(eD(i.prototype), "init", this).call(this),
              ...
              },
              {
                key: "updatePageMode",
                value: function () {
                  eM(eD(i.prototype), "updatePageMode", this).call(this);
                  var e = this.app;
                  ((this.has3DCover =
              ...
              },
              {
                key: "initStage",
                value: function () {
                  var e = (this.stage = new eL.Stage({
                    pixelRatio: this.app.options.pixelRatio,
                  }));
                  ((e.canvas = eH(e.renderer.domElement).addClass(
                    "df-3dcanvas",
                  )).appendTo(this.element),
                    ...
                    (e.spotLight.castShadow =
                      !eU.isMobile && this.app.options.has3DShadow),
              ...
              },
              {
                ...
                value: function () {
                  ((this.stageDOM = this.element[0]),
                    eM(eD(i.prototype), "initEvents", this).call(this));
                },
              },
              {
                key: "dispose",
                value: function () {
                  (eM(eD(i.prototype), "dispose", this).call(this),
                    this.stage &&
                      ...
                      (this.stage.orbitControl = eU.disposeObject(
                        this.stage.orbitControl,
                      )),
                      (this.stage.renderer = eU.disposeObject(
                        this.stage.renderer,
                      )),
                      eH(this.stage.canvas).remove(),
                      (this.stage.canvas = null),
                      (this.stage = eU.disposeObject(this.stage))),
                    this.centerTween &&
              ...
              },
              {
                key: "resize",
                value: function () {
                  eM(eD(i.prototype), "resize", this).call(this);
                  var e = this,
                    t = e.app,
                    n = e.stage,
                    o = t.dimensions;
              ...
              { key: "updateShadowSize", value: function () {} },
              {
                ...
                value: function () {
                  ...
                  ((this.leftFlexibility = r * (1 - o)),
                    ...
                    eM(eD(i.prototype), "refresh", this).call(this));
                ...
                value: function (e) {
                  ...
                  if (
                    ...
                    var i = this.dragSheet.width,
                      ...
                      o = eU.limitAt(1 - n / i, -1, 1),
                      s = eU.toDeg(Math.acos(o)),
                      a = this.dragSheet,
                      r = this.drag === p.TURN_DIRECTION.LEFT;
                    a.sheetAngle = s;
                    var l = eU.getCurveAngle(r, s, 45);
              ...
              },
              {
                key: "mouseUp",
                value: function (e) {
                  if ((e = eU.fixMouseEvent(e)).touches || 0 === e.button) {
                    if (
                      null == this.dragSheet &&
                      null != e.touches &&
                      0 === e.touches.length
              ...
              },
              {
                ...
                value: function (e) {
                  var t = this.app.dimensions,
                    i = { x: (e = eU.fixMouseEvent(e)).clientX, y: e.clientY };
                  ((i.x =
              ...
              },
              {
                key: "getTextureSize",
                value: function (e) {
                  var t = eM(eD(i.prototype), "getTextureSize", this).call(
                    this,
                    e,
                  );
                  if (1 !== this.app.zoomValue || !0 === e.isAnnotation)
                    return t;
                  var n = eU.nearestPowerOfTwo(t.height),
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return eM(eD(i.prototype), "getPageByNumber", this).call(
                    this,
                    e,
                  );
                },
              },
              {
                key: "setPage",
                value: function (e) {
                  return eM(eD(i.prototype), "setPage", this).call(this, e);
                },
              },
              {
                key: "beforeFlip",
                value: function () {
                  eM(eD(i.prototype), "beforeFlip", this).call(this);
                },
              },
            ]),
            i
      ...
      ((ej.prototype.resizeAnnotations = function (e) {
        ...
        (ej.prototype.finalizeAnnotations = function (e, t) {
          (X.prototype.finalizeAnnotations.call(this, e, t),
            this.resizeAnnotations(t));
        }),
        (ej.prototype.updateCSSLayer = function () {
          var e,
            t,
            i = this.getBasePage(),
          ...
          eX(this.stage.cssRenderer.domElement)
        ...
        (ej.prototype.initSpiral = function () {
          if (
        ...
        (ej.prototype.set3DCoverNormal = function () {
          ...
          if (e !== p.FLIPBOOK_COVER_TYPE.PLAIN) {
            ...
            ((s.fillStyle = n),
              ...
              s.closePath(),
              s.fill(),
              this.leftCover.element.loadNormalMap(o, eL.MATERIAL_FACE.FRONT));
            ...
            ((r.fillStyle = n),
              ...
              r.closePath(),
              r.fill(),
              this.rightCover.element.loadNormalMap(a, eL.MATERIAL_FACE.BACK));
          }
        }),
        (ej.prototype.setcolor3DCover = function () {
          var e =
          ...
          0 == (e = e.trim()).indexOf("#") &&
            ...
            (e = e
              ...
              .join(""));
          var t = eQ.color.getBrightness(e);
          isNaN(t) &&
            (console.log(
        ...
        (ej.prototype.refreshSpiral = function () {
          if (!0 === this.hasSpiral) {
        ...
        var t,
          ...
          n =
            ...
            function () {
              ...
              return (
                (e = t
                  ? Reflect.construct(i, arguments, eZ(this).constructor)
                  : i.apply(this, arguments)),
                e &&
                ("object" ==
          ...
          (i = [
            {
              key: "init",
              value: function () {
                (eG(eZ(o.prototype), "init", this).call(this),
            ...
            },
            {
              ...
              value: function (e) {
                var t =
                  ...
                  void 0 !== arguments[1] &&
                  arguments[1];
                return eG(eZ(o.prototype), "getAnnotationElement", this).call(
                  this,
                  e,
                  t,
                  !0,
            ...
            },
            {
              ...
              value: function (e) {
                var t =
                  ...
                  void 0 !== arguments[1] &&
                  arguments[1];
                return eG(eZ(o.prototype), "getTextElement", this).call(
                  this,
                  e,
                  t,
                  !0,
            ...
            },
            {
              ...
              value: function (e, t) {
                ((this.skipCenterAnimation = !0),
                  eG(eZ(o.prototype), "exchangeTexture", this).call(this, e, t),
      ...
      function e1(e, t, i) {
        return (t && e0(e.prototype, t), i && e0(e, i), e);
      }
      function e2(e) {
        return (e2 = Object.setPrototypeOf
          ? Object.getPrototypeOf
          : function (e) {
              return e.__proto__ || Object.getPrototypeOf(e);
            })(e);
      ...
      ((X.prototype.isVertical = function () {
        return !0 === this.app.options.calendarMode;
      }),
        (x.prototype.afterConstructor = function () {
        ...
        (p.viewers.flipbook = function e(t, i) {
          ...
          "flat3D" === t.is3D)
            ? ((t.flexibility = 0), new eY(t, i))
            : eQ.isTrue(t.is3D)
              ? new ej(t, i)
              : new eu(t, i);
        }),
        (p.viewers.default = p.viewers.reader = F),
        (p.viewers.slider = eP));
      var e8 = p.jQuery,
        e9 = p.utils,
            ...
            e1(e, [
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  var s = (0, e9.removeNullCharacters)(t);
                  o
                    ? (e.href = e.title = s)
                    : ((e.href = ""),
                    ...
                    o = function (t) {
                      ...
                      s
                        ? ((s = n.pdfApp.viewer.getViewerPageNumber(s)) >
                          ...
                          e9.log("Loading for:", t, " at page ", s),
                          ...
                          t.num + " " + t.gen + " R"
                            ...
                            : e9.log("Expired Request for ", s, " with ", t))
                  ...
                  if (e instanceof Array) {
                    ...
                    if (i) {
                      var n = this.getAnchorUrl("#page=" + i),
                        o = e[1];
                      if (
                        (void 0 === o ? "undefined" : e3(o)) === "object" &&
                        "name" in o &&
                        "XYZ" === o.name
                      ) {
          ...
          var t,
            n =
              ...
              function () {
                ...
                return (
                  (e = t
                    ? Reflect.construct(i, arguments, e2(this).constructor)
                    : i.apply(this, arguments)),
                  e && ("object" === e3(e) || "function" == typeof e)
                    ? e
                    : eJ(this)
                );
              });
          function o(e, t) {
            ...
            var s,
              ...
              r = function (e) {
                ...
                ((t.href = l.options.pdfjsWorkerSrc + h.cacheBustParameters),
                  ...
                  !0 === p.loadCorsPdfjsWorker
                    ? (l.updateInfo(
                      ...
                      e8.ajax({
                        url: l.options.pdfjsWorkerSrc + h.cacheBustParameters,
                        cache: !0,
                        success: function (t) {
                          ((l.options.pdfjsWorkerSrc = e9.createObjectURL(
                            t,
                            "text/javascript",
                          )),
                            "function" == typeof e && e());
              ...
              l = (s = n.call(this, e, t)).app,
              h = eJ(s);
            return (
              (h.pdfDocument = void 0),
              (h._page2Ratio = void 0),
              (h.cacheBustParameters =
                "?ver=" + p.version + "&pdfver=" + l.options.pdfVersion),
              (a = function () {
                ((pdfjsLib.GlobalWorkerOptions.workerSrc =
                  l.options.pdfjsWorkerSrc + h.cacheBustParameters),
              ...
              "undefined" == typeof pdfjsLib
                ? (l.updateInfo(l.options.text.loading + " PDF Service ..."),
                  e9.getScript(
                    l.options.pdfjsSrc + h.cacheBustParameters,
                    function () {
            ...
            e1(o, [
              {
                ...
                value: function () {
                  (this.pdfDocument && this.pdfDocument.destroy(),
                    (this.linkService = e9.disposeObject(this.linkService)),
              ...
              },
              {
                ...
                value: function () {
                  var e = this.app,
                    ...
                    n = t.pdfParameters || {};
                  if (
                    ((n.url = e9.httpsCorrection(n.url || t.source)),
                ...
                value: function (e) {
                  ...
                  if (
                    ...
                    (t.applyTexture(this.getCache(n, a.height), e),
                      e9.log("Texture loaded from cache for : " + n));
                    return;
                  }
                  var r = t.viewer.getDocumentPageNumber(n);
                  (e9.log("Requesting PDF Page:" + r),
                    i.pdfDocument
                      .getPage(r)
                      .then(function (l) {
                        i.viewPorts[n] ||
      ...
      function tn(e, t, i) {
        return (t && ti(e.prototype, t), i && ti(e, i), e);
      }
      function to(e) {
      ...
      var ta = p.jQuery,
        ...
        th = /*#__PURE__*/ (function () {
          function e(t) {
            ...
            for (var i = 0; i < t.length; i++)
              ((this.source[i] = tr.httpsCorrection(t[i].toString())),
                this.pages.push(new tl({ src: this.source[i] })));
          }
          return (
            tn(e, [
              {
        ...
        tp = /*#__PURE__*/ (function (e) {
          ...
          var t,
            i =
              ...
              function () {
                ...
                return (
                  (e = t
                    ? Reflect.construct(i, arguments, to(this).constructor)
                    : i.apply(this, arguments)),
                  e &&
                  ("object" ==
                    (e &&
          ...
          function n(e, t) {
            ...
            var o,
              ...
              a = te(o);
            return (
              (a.document = new th(s.options.source)),
      ...
      function tf(e, t, i) {
        return (t && td(e.prototype, t), i && td(e, i), e);
      }
      function tg(e) {
        return e && "undefined" != typeof Symbol && e.constructor === Symbol
          ? "symbol"
      ...
      var tv = p.jQuery,
        ...
        tb = /*#__PURE__*/ (function () {
          function e(t, i) {
            (tc(this, e),
              ...
              (this.element = tv("<div>", { class: "df-ui" })),
              (this.leftElement = tv("<div>", { class: "df-ui-left" }).appendTo(
                this.element,
              )),
              (this.centerElement = tv("<div>", {
                class: "df-ui-center",
              }).appendTo(this.element)),
              (this.rightElement = tv("<div>", {
                class: "df-ui-right",
              }).appendTo(this.element)),
              this.parentElement.append(this.element),
              (this.events = {}),
            ...
            tf(e, [
              {
                ...
                value: function () {
                  ...
                  ((this.pageInput = n.pageInput =
                    tv('<input id="' + a + '" type="text"/>').appendTo(
                      n.pageNumber,
                    )),
                    (this.pageLabel = n.pageLabel =
                      tv('<label for="' + a + '"></label>').appendTo(
                        n.pageNumber,
                      )),
                    ...
                    i.hasOutline() &&
                      ((this.outline = n.outline =
                        tm.createBtn("outline", s.outline, o.toggleOutline)),
                      n.outline
                        .on("click", function () {
                          var t = tv(this);
                          if (
                    ...
                    !0 === i.options.showSearchControl &&
                      ...
                      ((n.search = tm.createBtn("search", s.search, o.search)),
                      n.search
                        .on("click", function () {
                          var t = tv(this);
                          if (
                  ...
                  if (
                    ((this.share = n.share =
                      tm
                        ...
                        .on("click", function () {
                          (null == e.shareBox &&
                            (e.shareBox = new tw(i.container, i.options)),
                            !0 === e.shareBox.isOpen
                              ? e.shareBox.close()
                    ...
                    (this.more = n.more =
                      tm.createBtn("more", s.more).on("click", function (t) {
                        !0 !== e.moreContainerOpen &&
                          (tv(this).addClass("df-active"),
                    ...
                    !0 === i.options.showPrintControl &&
                      ...
                      (this.print = n.print =
                        tm
                          ...
                          .on("click", function () {
                            ((p.printHandler = p.printHandler || new tS()),
                    ...
                    ((this.download = n.download =
                      ...
                      n.download
                        .attr("href", tm.httpsCorrection(i.options.source))
                        .attr("title", o.downloadPDFFile));
                  }
                  ((e.moreContainer = tv(t, { class: "df-more-container" })),
                  ...
                  for (var f = 0; f < u.length; f++) {
                    ...
                    if (0 > d.indexOf("," + g + ",")) {
                      var v = n[g];
                      null != v &&
                        (void 0 === v ? "undefined" : tg(v)) == "object" &&
                        (c.indexOf("," + g + ",") > -1 &&
                        "more" !== g &&
                        "pageNumber" !== g
              ...
              },
              {
                ...
                value: function (e) {
                  void 0 === tm.getFullscreenElement() &&
                    ...
                    switch (
                      (t.options.arrowKeysAction === p.ARROW_KEYS_ACTIONS.NAV &&
                        ...
                        !0 != t.options.isLightBox &&
                          ...
                          !1 === tv("body").hasClass("df-lightbox-open") &&
                          (i = !0)),
                      e.keyCode)
                    ) {
                      case 27:
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (e.options.logo.indexOf("<") > -1
                    ? (t = tv(e.options.logo).addClass("df-logo df-logo-html"))
                ...
                value: function () {
                  for (var e in this.controls)
                    if (this.controls.hasOwnProperty(e)) {
                      ...
                      null !== t &&
                        (void 0 === t ? "undefined" : tg(t)) == "object" &&
                        t.off().remove();
                    }
                  (this.element.remove(),
                    (this.shareBox = tm.disposeObject(this.shareBox)),
                ...
                value: function () {
                  ...
                  if ((e.container.toggleClass("df-search-open", n), n)) {
                    ...
                    if (
                      ...
                      var s = e.searchResults[0],
                        a = s.scrollTop;
                      a + s.getBoundingClientRect().height <
                      (o = o[0]).offsetTop + o.scrollHeight
                        ? tm.scrollIntoView(o, null, !1)
                        : a > o.offsetTop && tm.scrollIntoView(o);
                    }
                  }
            ...
            tf(e, [
              {
                ...
                value: function (e, t) {
                  var i = this;
                  for (var n in ((i.wrapper = tv(
                    '<div class="df-share-wrapper" style="display: none;">',
                  ).on("click", function () {
                    i.close();
                  })),
                  (i.box = tv('<div class="df-share-box">')),
        ...
        tP = /*#__PURE__*/ (function () {
          function e(t) {
            (tc(this, e), (this.duration = 300));
            var i = this;
            return (
              (i.lightboxWrapper = tv("<div>").addClass("df-lightbox-wrapper")),
              (i.backGround = tv("<div>")
                ...
                value: function (e) {
                  return (
                    0 === this.lightboxWrapper.parent().length &&
                      tv("body").append(this.lightboxWrapper),
                    tv("html,body").addClass("df-lightbox-open"),
              ...
              },
              {
                ...
                value: function (e) {
                  return (
                    ...
                    tv("html,body").removeClass("df-lightbox-open"),
        ...
        tE = /*#__PURE__*/ (function () {
          function e(t, i) {
            (tc(this, e),
              ...
              (this.app = i),
              (this.parentElement = t.parentElement),
              (this.element = tv("<div>", { class: "df-sidemenu-wrapper" })),
              this.parentElement.append(this.element),
              (this.buttons = tv("<div>", {
                class: "df-sidemenu-buttons df-ui-wrapper",
              }).appendTo(this.element)),
              (this.close = tm.createBtn(
                "close",
        ...
        tC = /*#__PURE__*/ (function () {
          function e(t) {
            tc(this, e);
            var i = function () {
                ((s.thumbRequestCount = 0), (s.thumbRequestStatus = ty.COUNT));
              },
            ...
            tf(e, [
              {
                ...
                value: function () {
                  tm.log("Thumb Request Initiated");
                  var e = this.app;
                  if (
                    ((e.thumbRequestStatus = ty.OFF),
                    ...
                    o.length > 0
                      ? (e.thumbContainer
                        ...
                        i + n < (o = o[0]).offsetTop + o.scrollHeight
                          ? tm.scrollIntoView(o, null, !1)
                          : i > o.offsetTop && tm.scrollIntoView(o),
                        (e.activeThumb = e.currentPageNumber))
                      : (tv(t).scrollTop(124 * e.currentPageNumber),
                        (e.thumbRequestStatus = ty.ON));
                  }
                  if (
                    0 ===
                    ...
                    for (var a = 0; a < s.length; a++) {
                      ...
                      if (
                        ...
                        return (
                          ...
                          tm.log("Thumb Requested for " + s[a]),
                ...
                value: function (e) {
                  ...
                  if (e.textureTarget === p.TEXTURE_TARGET.THUMB) {
                    ...
                    (o
                      ...
                      o
                        .find(".df-bg-image")
                        .css({ backgroundImage: tm.bgImage(n) }),
                      o
                        .addClass("df-thumb-loaded")
                        .removeClass("df-thumb-requested"));
                  }
                  (tm.log("Thumbnail set for " + e.pageNumber),
                    (t.thumbRequestStatus = ty.ON));
                },
              },
            ]),
            e
      ...
      ((p.openLightBox = function (e) {
        (p.activeLightBox ||
          (p.activeLightBox = new tP(function () {
            (p.activeLightBox.app &&
              ...
              (p.activeLightBox.app = tm.disposeObject(p.activeLightBox.app)));
          })),
        ...
        (p.initControls = function () {
          ...
          if (
            ...
            var t = tv(p.fileDropElement);
            t.length > 0 &&
              (t.on("dragover", function (e) {
                (e.preventDefault(),
                  e.stopPropagation(),
                  tv(this).addClass("df-dragging"));
              }),
              t.on("dragleave", function (e) {
                (e.preventDefault(),
                  e.stopPropagation(),
                  tv(this).removeClass("df-dragging"));
              }),
        ...
        tL = /*#__PURE__*/ (function () {
          ...
          function t(e) {
            ...
            ((function (e, t) {
              ...
              (this.startPage = 1),
              (this.endPage = 1),
              (this.element = tk(this.options.element)),
              (e.maxTextureSize =
              ...
              (this.is3D = e.is3D),
              (this.options.pixelRatio = tR.limitAt(
              ...
              (this.jumpStep = 1),
              (this.resizeRequestStatus = tO.OFF),
              (this.refreshRequestStatus = tO.OFF),
              (this.refreshRequestCount = 0),
              (this.resizeRequestCount = 0),
              (this.fullscreenSupported = tR.hasFullscreenEnabled()),
          ...
          return (
            (e = [
              ...
              },
              {
                ...
                value: function () {
                  (this.element
                    ...
                    (this.container = tk("<div>").appendTo(this.element)),
                    this.container.addClass(
                      "df-container df-loading df-init df-controls-" +
                        ...
                        ("transparent" === this.options.backgroundColor
                          ...
                          : "") +
                        (!0 === this.isRTL ? " df-rtl" : "") +
                        (!0 === tR.isIOS || !0 === tR.isIPad ? " df-ios" : ""),
                    ),
                    (this._offsetParent = this.container[0].offsetParent),
                    (this.backGround = tk("<div class='df-bg'>")
                      .appendTo(this.container)
                      .css({
                    ...
                    (this.viewerContainer = tk("<div>").appendTo(
                      this.container,
                    )),
              ...
              },
              {
                ...
                value: function (e) {
                  ((this.userHasInteracted = !0),
                    !0 === this.viewer.acceptAppMouseEvents &&
                      0 === tk(e.srcElement).closest(".df-sidemenu").length &&
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (clearInterval(this.autoPlayTimer),
                    ...
                    (this.provider = tR.disposeObject(this.provider)),
                    (this.contentProvider = null),
                    (this.target = null),
                    (this.viewer = tR.disposeObject(this.viewer)),
                    (this.sideMenu = tR.disposeObject(this.sideMenu)),
                    (this.ui = tR.disposeObject(this.ui)),
                    (this.thumblist = tR.disposeObject(this.thumblist)),
                    (this.outlineViewer = tR.disposeObject(this.outlineViewer)),
                    this.events &&
                      (window.removeEventListener(
                        "resize",
                        this.events.resize,
              ...
              },
              {
                ...
                value: function () {
                  ((this.resizeRequestStatus = tO.COUNT),
                    (this.resizeRequestCount = 0),
              ...
              },
              {
                key: "initInfo",
                value: function () {
                  ((this.info = tk("<div>", { class: "df-loading-info" })),
                    this.container.append(this.info),
                    this.info.html(this.options.text.loading + "..."),
                    (this.loadingIcon = tk("<div>", {
              ...
              },
              {
                key: "updateInfo",
                value: function (e, t) {
                  (tR.log(e), void 0 !== this.info && this.info.html(e));
                },
              },
              {
                key: "_documentLoaded",
                value: function () {
                  (tR.log("Document Loaded"),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  var t = tk("<div>").addClass("df-wrapper");
                  (e.append(t),
                    this.sideMenu.element.append(e),
                    (this.outlineContainer = e),
                    (this.outlineViewer = new tx({
                      container: t[0],
              ...
              },
              {
                ...
                value: function () {
                  ...
                  ((e.thumblist = new tC({
                    ...
                    addFn: function (e) {},
                    scrollFn: function () {
                      e.thumbRequestStatus = tO.ON;
                    },
                    itemHeight: e.thumbSize,
                    itemWidth: tR.limitAt(
                  ...
                  (t.append(
                    ...
                    t.append(tk(e.thumblist.container).addClass("df-wrapper")),
                    (e.thumbContainer = t),
                    ...
                    e.container.on(
                      ...
                      function (t) {
                        t.stopPropagation();
                        var i = tk(this).attr("id").replace("df-thumb", "");
              ...
              },
              {
                ...
                value: function () {
                  var e = this,
                    t = tk("<div>").addClass("df-search-container df-sidemenu");
                  (t.append(
                    '<div class="df-sidemenu-title">' +
                      this.options.text.searchTitle +
                      "</div>",
                  ),
                    (e.searchForm = tk('<div class="df-search-form">').appendTo(
                      t,
                    )),
                    (e.searchBox = tk(
                    ...
                    (e.searchButton = tk(
                      ...
                      .appendTo(e.searchForm)),
                    (e.clearButton = tk('<a class="df-search-clear">Clear</a>')
                      .on("click", function (t) {
                        e.clearSearch();
                      })
                      .appendTo(e.searchForm)),
                    (e.searchInfo = tk('<div class="df-search-info">').appendTo(
                      t,
                    )),
                    (e.searchResults = tk(
                  ...
                  if (
                    ...
                    (e.container &&
                      ...
                      null !== e._offsetParent &&
                        (e.resize(), (e.resizeRequestStatus = tO.OFF)),
                      tR.log("Visibility Resize Detected")),
                      (null !== e._offsetParent || e.isFullscreen) &&
                        (TWEEN.getAll().length > 0 &&
                          (TWEEN.update(), (e.renderRequestStatus = tO.ON)),
                        e.resizeRequestStatus === tO.ON
                          ? ((e.resizeRequestStatus = tO.OFF), e.resize())
                          : e.resizeRequestStatus === tO.COUNT &&
                            (e.resizeRequestCount++,
                            e.resizeRequestCount > 10 &&
                              ((e.resizeRequestCount = 0),
                              (e.resizeRequestStatus = tO.ON))),
                        e.refreshRequestStatus === tO.ON
                          ? ((e.refreshRequestStatus = tO.OFF),
                            (e.pendingResize = !1),
                            e.viewer.refresh(),
                            e.container.removeClass("df-pendingresize"))
                          : e.refreshRequestStatus === tO.COUNT &&
                            (e.refreshRequestCount++,
                            e.refreshRequestCount > 3 &&
                              ((e.refreshRequestCount = 0),
                              (e.refreshRequestStatus = tO.ON))),
                        e.textureRequestStatus === tO.ON &&
                          e.processTextureRequest(),
                        e.thumbRequestStatus === tO.ON
                          ? e.processThumbRequest()
                          : e.thumbRequestStatus === tO.COUNT &&
                            (e.thumbRequestCount++,
                            e.thumbRequestCount > 3 &&
                              ((e.thumbRequestCount = 0),
                              (e.thumbRequestStatus = tO.ON))),
                        e.renderRequestStatus === tO.ON &&
                          (e.viewer.render(), (e.renderRequestStatus = tO.OFF)),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (
                    ...
                    this.textureRequestStatus = tO.ON;
                  else {
                    tR.log("Texture Request Working");
                    ...
                    0 === s && (this.textureRequestStatus = tO.OFF);
                  }
                },
              },
              {
              ...
              },
              {
                ...
                value: function () {
                  ((this.refreshRequestStatus = tO.COUNT),
                    (this.refreshRequestCount = 0));
                },
              },
              {
                ...
                value: function () {
                  this.renderRequestStatus = tO.ON;
                },
              },
              {
                key: "resizeRequestStart",
                value: function () {
                  this.resizeRequestStatus = tO.ON;
                },
              },
              {
                key: "zoom",
              ...
              },
              {
                ...
                value: function () {
                  var e =
                    ...
                    void 0 === arguments[0] ||
                    arguments[0];
                  (tR.log("Resize Request Initiated"),
                    this.calculateLayout(),
                  ...
                  if (
                    ...
                    (n.requestFullscreen
                      ...
                      o &&
                        o.then &&
                        o.then(function () {
                          (i.refreshRequestStatus, tO.ON, i.resize());
                        }),
                      (i.isFullscreen = !0));
                  } else
                    ((i.isFullscreen = !1),
                        ...
                        : document.msExitFullscreen
                          ...
                          : document.mozCancelFullScreen
                            ...
                            : document.webkitExitFullscreen &&
                              document.webkitExitFullscreen(),
                      tR.hasFullscreenEnabled() ||
                        i.container[0].scrollIntoView());
                  tR.hasFullscreenEnabled() || (i.resizeRequestStatus = tO.ON);
                },
              },
              {
                key: "next",
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  ((t = tR.limitAt(t, this.startPage, this.endPage)),
              ...
              },
              {
                ...
                value: function () {
                  if (null != this.options.id) {
                    var e =
                      tR.getSharePrefix(this.options.sharePrefix) +
      ...
      ((p.prepareOptions = function (e) {
        e.element instanceof tk || (e.element = tk(e.element));
        var t = e.element;
        null == e.dataElement && (e.dataElement = t);
        var i = e.dataElement,
          n = p.utils.getOptions(i),
          o = tk.extend(!0, {}, p.defaults, e, n);
        ((o = tR.fallbackOptions(o)), tR.log(o));
        var s = tk.extend(!0, {}, p._defaults, o);
        return (
          tR.isMobile &&
          ...
          (s = tR.finalizeOptions(tR.sanitizeOptions(s)))
        );
      }),
      ...
      ((p.defaults.search = !0),
        (tL.prototype.executeCallback = function (e) {
          this.options &&
            "function" == typeof this.options[e] &&
            this.options[e](this);
        }),
        (tL.prototype.analytics = function (e) {
        ...
        (p.openAttachmentLightBoxes = function () {
          ...
          (e.length > 0 &&
            ((p._isHashTriggered = !0),
            t_(e[0]).trigger("click"),
            (p._isHashTriggered = !1)),
            t_(window).on("hashchange", function (e) {
              var t = location.hash;
              t &&
                t.length > 5 &&
                ((p.hashFocusBookFound = !1),
        ...
        (e7.prototype.processCustomLinks = function (e, t) {
          var i = this,
            n = this.app;
          if (
        ...
        (e6.prototype.processTextContent = function (e, t) {
          var i = this,
            n = this.app;
                  ...
                  ((r = a.getViewport({
                    ...
                    a.getTextContent().then(function (a) {
                      ...
                      (void 0 == p &&
                        ...
                        c &&
                        c.length > 0 &&
                        ((p = tN(a.items, i.textOffsetSearch[s], c)),
        ...
        (e6.prototype.renderAutoLinks = function (e, t, i, n) {
          if (e && e.length > 0) {
            var o,
              s,
              a = t_(i).siblings(".df-auto-link-content");
            (0 === a.length &&
              ((a = t_('<div class="df-auto-link-content">')),
              t_(i).parent().prepend(a)),
              a.html(""),
              (t.items = e),
              pdfjsLib.TextLayer
        ...
        (e6.prototype.renderSearchHits = function (e, t, i, n) {
          if (e && e.length > 0) {
            ((t.items = e),
              pdfjsLib.TextLayer
                ? (s = (o = new pdfjsLib.TextLayer({
        ...
        (tp.prototype.processAnnotations = function (e, t) {
      ...
      var tA = p.jQuery,
        tI = (window.DFLIP = window.DEARFLIP = p);
      ((window.dearPDFOpenFileOptions = p.openFileOptions),
        (window.DEARPDF = window.DEARFLIP),
        (tI.defaults.viewerType = "flipbook"),
        (tI.defaults.analyticsEventCategory = "Flipbook"),
        (tI.defaults.analyticsViewerReady = "Book Ready"),
        (tI.defaults.analyticsViewerOpen = "Open Book"),
        (tI.defaults.analyticsViewerClose = "Book Closed"),
        (tI.defaults.analyticsFirstPageChange = "First Page Flip"),
        (tI.slug = "dflip"),
        (tI.locationVar = "dFlipLocation"),
        (tI.locationFile = "dflip"),
        (tI.PAGE_MODE = { SINGLE: 1, DOUBLE: 2, AUTO: null }),
        (tI.SINGLE_PAGE_MODE = { ZOOM: 1, BOOKLET: 2, AUTO: null }),
        (tI.CONTROLSPOSITION = {
          HIDDEN: "hide",
          TOP: "top",
          BOTTOM: "bottom",
        }),
        (tI.DIRECTION = { LTR: 1, RTL: 2 }),
        (tI.PAGE_SIZE = { AUTO: 0, SINGLE: 1, DOUBLEINTERNAL: 2 }),
        (tI.ConvertPageLinks = function () {
          for (
            var e,
              t = arguments[0] / 100,
              i = arguments[1] / 100,
          ...
          if (null != e && e.length > 0)
            for (var i = 0; i < e.length; i++)
              null != (t = e[i]) &&
                null != t[0] &&
                null == t[0].dest &&
                ((t = tI.ConvertPageLinks.apply(this, t)), (e[i] = t));
          return e;
        }),
        (tI.parseFallBack = function () {
          (tA(".df-posts").addClass("dflip-books"),
            tA(".dflip-books").addClass("df-posts"),
            tA(
        ...
        (tI.parseBooks = function () {
          (tI.parseFallBack(), tI.parseElements());
        }));
      var tM = function (e) {
        if (
          (null != e.source &&
          ...
          null != e.cover3DType &&
            (!0 == e.cover3DType || "true" == e.cover3DType
              ? (e.cover3DType = tI.FLIPBOOK_COVER_TYPE.BASIC)
              : (!1 == e.cover3DType || "false" == e.cover3DType) &&
                (e.cover3DType = tI.FLIPBOOK_COVER_TYPE.NONE)),
          void 0 !== e.pageSize &&
            ("1" === e.pageSize ||
            1 === e.pageSize ||
            e.pageSize === tI.FLIPBOOK_PAGE_SIZE.SINGLE
              ? (e.pageSize = tI.FLIPBOOK_PAGE_SIZE.SINGLE)
              : "2" === e.pageSize ||
                  2 === e.pageSize ||
                  e.pageSize === tI.FLIPBOOK_PAGE_SIZE.DOUBLE_INTERNAL
                ? (e.pageSize = tI.FLIPBOOK_PAGE_SIZE.DOUBLE_INTERNAL)
                : e.pageSize === tI.FLIPBOOK_PAGE_SIZE.DOUBLE_COVER_BACK ||
                  (e.pageSize = tI.FLIPBOOK_PAGE_SIZE.AUTO)),
          void 0 !== e.pageMode &&
            ("1" === e.pageMode ||
            1 === e.pageMode ||
            e.pageMode === tI.FLIPBOOK_PAGE_MODE.SINGLE
              ? (e.pageMode = tI.FLIPBOOK_PAGE_MODE.SINGLE)
              : "2" === e.pageMode ||
                  2 === e.pageMode ||
                  e.pageMode === tI.FLIPBOOK_PAGE_MODE.DOUBLE
                ? (e.pageMode = tI.FLIPBOOK_PAGE_MODE.DOUBLE)
                : (e.pageMode = tI.FLIPBOOK_PAGE_MODE.AUTO)),
          void 0 !== e.singlePageMode &&
            ("1" === e.singlePageMode ||
            1 === e.singlePageMode ||
            e.singlePageMode === tI.FLIPBOOK_SINGLE_PAGE_MODE.ZOOM
              ? (e.singlePageMode = tI.FLIPBOOK_SINGLE_PAGE_MODE.ZOOM)
              : "2" === e.singlePageMode ||
                  2 === e.singlePageMode ||
                  e.singlePageMode === tI.FLIPBOOK_SINGLE_PAGE_MODE.BOOKLET
                ? (e.singlePageMode = tI.FLIPBOOK_SINGLE_PAGE_MODE.BOOKLET)
                : (e.singlePageMode = tI.FLIPBOOK_SINGLE_PAGE_MODE.AUTO)),
          void 0 !== e.controlsPosition &&
            "hide" === e.controlsPosition &&
            (e.controlsPosition = tI.CONTROLS_POSITION.HIDDEN),
          ...
          void 0 !== e.scrollWheel &&
            (v.isTrue(e.scrollWheel) &&
              (e.mouseScrollAction = tI.MOUSE_SCROLL_ACTIONS.ZOOM),
          ...
          void 0 !== e.direction &&
            ("2" === e.direction ||
            2 === e.direction ||
            e.direction === tI.READ_DIRECTION.RTL
              ? (e.readDirection = tI.READ_DIRECTION.RTL)
              : (e.readDirection = tI.READ_DIRECTION.LTR),
            delete e.direction),
          void 0 !== e.hard &&
          ...
          if (!0 !== e.linksparsed) {
            ...
            e.links = tI.parseLinks(t);
          }
        } else e.links = tI.parseLinks(e.links);
      ...
      (void 0 !== window.jQuery &&
        ...
        tA(document).ready(function () {
          var e = tA("body");
          (tI.executeCallback("beforeDearFlipInit"),
            void 0 !== window.dFlipWPGlobal &&
              tA.extend(!0, tI.defaults, tM(window.dFlipWPGlobal)),
            tI.initUtils(),
            tI.initControls(),
            e.on(
              "click",
              ...
              function (e) {
                ...
                ("#" === n || void 0 === n || t.hasClass("df-hash-focused")
                  ...
                  : "_self" === i ||
                    "_blank" === i ||
                    (void 0 == i && "_self" === tI.defaults.targetWindow
                      ? t.attr("target", "_self")
                      : void 0 == i && "_blank" === tI.defaults.targetWindow
            ...
            e.on("click", ".df-trigger", function (e) {
              var t = tA(this).attr("df-trigger");
              return (tA("[df-trigger-id='" + t + "']").trigger("click"), !1);
            }),
            tI.checkBrowserURLforDefaults(),
            tI.parseCSSElements(),
            tI.parseFallBack(),
            v.detectHash(),
            tI.parseNormalElements(),
            tI.openAttachmentLightBoxes(),
            tI.executeCallback("afterDearFlipInit"));
        }),
        (v.finalizeOptions = function (e) {
          return tM(e);
        }),
        ...
        tI.executeCallback("onDearFlipLoad"));
    })());
})();
